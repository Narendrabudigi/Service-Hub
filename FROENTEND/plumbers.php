...
<center><div class="caption"><h1>Plumbers</h1></div> </center>
<form class="search"method=post action="plumbers-filter.php">
...
<div class="portfolio-container">
   ...
   include "dbconfig.php";
    $res=mysqli_query($conn, "select * from workers where worktype='plumber'") or die(mysqli_error($conn));
    if (!$res) {
