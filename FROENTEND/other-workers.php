...
<body>
    ...
    <form class="search" method="post" action="other-workers-filter.php">
    ...
    <div class="portfolio-container">
        ...
        $res = mysqli_query($conn, "SELECT * FROM workers WHERE worktype NOT IN ('carpenter', 'electrician', 'plumber', 'painter', 'machanic', 'mason')") or die(mysqli_error($conn));
        if (!$res) {
