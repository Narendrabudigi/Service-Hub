...
<center><div class="caption"><h1>Masons</h1></div> </center>
<form class="search"method=post action="masons-filter.php">
...
<div class="portfolio-container">
   ...
   include "dbconfig.php";
    $res=mysqli_query($conn, "select * from workers where worktype='mason'") or die(mysqli_error($conn));
    if (!$res) {
    ...
    <center> <img src="<?php echo $w_image;?>" alt="Worker Image" style="border-radius:50%;margin-left:-10%;height: 100px;width:100pxmargin-top:3%;"></center>
