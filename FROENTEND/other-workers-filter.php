...
<body>
    ...
    <center><div class="caption"><h1>Other Workers</h1></div> </center>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM workers WHERE shoplocation = '$shop' AND worktype NOT IN ('carpenter', 'electrician', 'plumber', 'painter', 'machanic', 'mason')";
    ...
    <?php
            ...
            window.location.href="other-workers.php";</script>';
        }
