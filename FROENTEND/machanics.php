...
<center><div class="caption"><h1>Mechanics</h1></div> </center>
<form class="search"method=post action="machanics-filter.php">
...
<div class="portfolio-container">
   ...
   include "dbconfig.php";
    $res=mysqli_query($conn, "select * from workers where worktype='machanic'") or die(mysqli_error($conn));
    if (!$res) {
