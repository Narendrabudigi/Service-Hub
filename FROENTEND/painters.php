...
<center><div class="caption"><h1>Painters</h1></div> </center>
<form class="search"method=post action="painters-filter.php">
...
<div class="portfolio-container">
   ...
   include "dbconfig.php";
    $res=mysqli_query($conn, "select * from workers where worktype='painter'") or die(mysqli_error($conn));
    if (!$res) {
